...
export default function OperatorLoginPage() {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-green-300 via-green-400 to-emerald-400 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-500">
        {/* Back Button */}
        <motion.div
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <motion.div
            ...
            className="absolute -bottom-32 -left-32 w-64 h-64 bg-emerald-200 dark:bg-emerald-800 rounded-full blur-3xl"
          />
        </div>
        ...
        >
          {isLoading ? (
            ...
            <CompactLoginForm userType="operator" redirectTo="/operator/dashboard" />
          )}
        </motion.div>
