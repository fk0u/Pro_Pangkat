  ...
  const fetchTimelineData = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const formattedData = data.timelines?.map((item: any) => ({
          id: item.id,
          title: item.title,
        ...
        const mockData: TimelineEvent[] = [
          ...
          {
            id: "3",
            title: "Review dan Persetujuan Admin Dinas",
            description: "Proses review dan persetujuan oleh admin dinas pendidikan",
      ...
      setLoading(false)
        ...
        {
          id: "4",
          title: "Pengiriman ke BKN",
          description: "Pengiriman berkas yang telah diverifikasi ke BKN",
        ...
        {
          id: "5",
          title: "Penetapan SK Kenaikan Pangkat",
          description: "Penetapan dan penerbitan SK kenaikan pangkat oleh BKN",
