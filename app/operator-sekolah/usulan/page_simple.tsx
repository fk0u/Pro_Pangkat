              ...
              <div className="space-y-6 mt-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <div className="mt-1 p-2 bg-blue-50 rounded border text-sm">
                          <span className="font-semibold text-blue-600">
                            {selectedUsulan.golonganAsal} → {selectedUsulan.golonganTujuan}
                          </span>
                        </div>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <div className="mt-1 p-2 bg-yellow-50 rounded border text-sm">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-700 mt-1">
                          Pegawai <strong>{selectedUsulan.nama}</strong> harus login dan mengupload 
                  ...
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <p className="text-sm">Pegawai perlu mengupload dokumen persyaratan</p>
                  </div>
                </div>
              </div>
            )}
